...
> NOTE: You are allowed to work on this project with one other person, if you want to. But that is not required. See the ["Submission & Grading"](#submission-&-grading) section at the bottom for instructions.
